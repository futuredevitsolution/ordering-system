...
<head>
    ...
    <link rel="icon" href="#">
    <title>TRICOR BUILDER|| Online Ordering System</title>
    ...
    <div class="page-wrapper">
        ...
        <?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
        <section class="inner-page-hero bg-image" data-image-src="images/img/background2.jpg">
            <div class="profile">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="food-item">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-lg-3 pull-right item-cart-info">
                                        <span class="price pull-left"><p>&#8369;<?php echo  $product['price']; ?></p></span>
