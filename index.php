...
<head>
    ...
    <link rel="icon" href="#">
    <title>Home || Online Ordering</title>
...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/final-logo.png" alt="" width="20%">  </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/background1.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>TRICOR BUILDERS </h1>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" width="200 px" data-image-src="admin/Res_img/dishes/'.$r['img'].'"></div>
                                                <div class="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <H2 class="pay-info text-xs-center"><b>Cash on Delivery</b></h2>
                </div>
            </div>
        </div>
    </section>
