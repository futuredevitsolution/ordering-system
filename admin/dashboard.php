            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-blue">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/tricor-builder.jpg" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-list-alt" aria-hidden="true"></i><span class="hide-menu">Product</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="all_menu.php">All Product</a></li>
                                <li><a href="add_menu.php">Add Add</a></li>
